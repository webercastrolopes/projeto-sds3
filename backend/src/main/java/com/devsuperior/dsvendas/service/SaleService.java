...
public class SaleService {
	...
	@Transactional(readOnly = true)         // evita ficar voltando no banco de dados para cada vendedor - para resolver a paginacao sem que tenha varios acesso as tabelas
	...
	//                                                em 'SaleRepositorie'.
	// feito isto agora vamos no 'Controlador'
}	
